 ...
 */
final class Version20240425152415 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE mentoroffers CHANGE idMentor Mentor INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE mentoroffers CHANGE Mentor idMentor INT DEFAULT NULL');
